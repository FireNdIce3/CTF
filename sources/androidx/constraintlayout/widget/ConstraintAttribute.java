...
public class ConstraintAttribute {
    ...
    static /* synthetic */ class C02521 {
        ...
        static {
            ...
            try {
                f99x66adad53[AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f99x66adad53[AttributeType.INT_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f99x66adad53[AttributeType.FLOAT_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f99x66adad53[AttributeType.STRING_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f99x66adad53[AttributeType.BOOLEAN_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f99x66adad53[AttributeType.DIMENSION_TYPE.ordinal()] = 7;
    ...
    public int noOfInterpValues() {
        switch (C02521.f99x66adad53[this.mType.ordinal()]) {
            case 1:
            case 2:
                return 4;
            default:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String name : map.keySet()) {
            ...
            try {
                switch (C02521.f99x66adad53[constraintAttribute.mType.ordinal()]) {
                    case 1:

...
public class ImageFilterView extends AppCompatImageView {
    ...
    static class ImageMatrix {
        ...
        public void updateMatrix(ImageView view) {
            ...
            if (f != 1.0f) {
                saturation(f);
                this.mColorMatrix.set(this.f98m);
                filter = true;
            }
            ...
            if (f3 != 1.0f) {
                warmth(f3);
                this.mTmpColorMatrix.set(this.f98m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                filter = true;
            }
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            Drawable drawable = a.getDrawable(C0015R.styleable.ImageFilterView_altSrc);
            for (int i = 0; i < N; i++) {
        ...
        if (round != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    C02501 r2 = new ViewOutlineProvider() {
    ...
    public void setRound(float round) {
        ...
        if (round != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    C02512 r2 = new ViewOutlineProvider() {
                        public void getOutline(View view, Outline outline) {

...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f81x;
    }

    /* access modifiers changed from: package-private */
    public float getStartY() {
        return this.mStartMotionPath.f82y;
    }

    /* access modifiers changed from: package-private */
    public float getFinalX() {
        return this.mEndMotionPath.f81x;
    }

    /* access modifiers changed from: package-private */
    public float getFinalY() {
        return this.mEndMotionPath.f82y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f81x;
        start.top = this.mStartMotionPath.f82y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f81x;
        end.top = this.mEndMotionPath.f82y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f81x - this.mStartMotionPath.f81x;
        float dy = this.mEndMotionPath.f82y - this.mStartMotionPath.f82y;
        float startCenterX = this.mStartMotionPath.f81x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f82y + (this.mStartMotionPath.height / 2.0f);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f81x + " y: " + this.mStartMotionPath.f82y + " end: x: " + this.mEndMotionPath.f81x + " y: " + this.mEndMotionPath.f82y;
    }
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f81x + ((this.mEndMotionPath.f81x - this.mStartMotionPath.f81x) * position);
            float float_t = this.mStartMotionPath.f82y + ((this.mEndMotionPath.f82y - this.mStartMotionPath.f82y) * position);
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f81x - this.mStartMotionPath.f81x;
        float dTop = this.mEndMotionPath.f82y - this.mStartMotionPath.f82y;

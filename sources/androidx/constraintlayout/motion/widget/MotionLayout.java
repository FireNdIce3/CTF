...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState newState) {
        if (newState != TransitionState.FINISHED || this.mCurrentState != -1) {
            ...
            switch (C02312.f79xabc7e4ac[oldState.ordinal()]) {
                case 1:
                case 2:
    ...
    static /* synthetic */ class C02312 {
        ...
        static {
            ...
            try {
                f79xabc7e4ac[TransitionState.SETUP.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f79xabc7e4ac[TransitionState.MOVING.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f79xabc7e4ac[TransitionState.FINISHED.ordinal()] = 4;
    ...
    private static class MyTracker implements MotionTracker {
        ...
        /* renamed from: me */
        private static MyTracker f80me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f80me.tracker = VelocityTracker.obtain();
            return f80me;
        }

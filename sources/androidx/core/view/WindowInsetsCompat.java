            ...
            switch (type) {
                ...
                case 2:
                    if (ignoreVisibility) {
                        ...
                        return Insets.m4of(Math.max(rootStable.left, stable.left), 0, Math.max(rootStable.right, stable.right), Math.max(rootStable.bottom, stable.bottom));
                    }
                    ...
                    return Insets.m4of(systemWindow.left, 0, systemWindow.right, bottom);
                case 8:
                    ...
                    if (systemWindow2.bottom > rootStable2.bottom) {
                        return Insets.m4of(0, 0, 0, systemWindow2.bottom);
                    }
                ...
                case 128:
                    ...
                    if (cutout != null) {
                        return Insets.m4of(cutout.getSafeInsetLeft(), cutout.getSafeInsetTop(), cutout.getSafeInsetRight(), cutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                default:
                    return Insets.NONE;
        ...
        private Insets getVisibleInsets(View rootView) {
            if (Build.VERSION.SDK_INT < 30) {
                ...
                try {
                    ...
                    if (visibleRect != null) {
                        return Insets.m5of(visibleRect);
                    }
                    return null;
            ...
            try {
                ...
                if (attachInfo != null) {
                    ...
                    if (!(stableInsets == null || visibleInsets == null)) {
                        WindowInsetsCompat insets = new Builder().setStableInsets(Insets.m5of(stableInsets)).setSystemWindowInsets(Insets.m5of(visibleInsets)).build();

...
public class ShapePath {
    ...
    public void lineTo(float x, float y) {
        ...
        float unused = operation.f153x = x;
        float unused2 = operation.f154y = y;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            RectF rect = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f154y - this.startY), (double) (this.operation.f153x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f154y - this.startY) / (this.operation.f153x - this.startX))));
        }
    }

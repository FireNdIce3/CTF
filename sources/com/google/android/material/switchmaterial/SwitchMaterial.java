...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C0098R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attrs) {
        this(context, attrs, C0098R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C0098R.styleable.SwitchMaterial
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r1 = com.google.android.material.C0098R.styleable.SwitchMaterial_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int colorSurface = MaterialColors.getColor(this, C0098R.attr.colorSurface);
            int colorControlActivated = MaterialColors.getColor(this, C0098R.attr.colorControlActivated);
            float thumbElevation = getResources().getDimension(C0098R.dimen.mtrl_switch_thumb_elevation);
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            ...
            int colorSurface = MaterialColors.getColor(this, C0098R.attr.colorSurface);
            int colorControlActivated = MaterialColors.getColor(this, C0098R.attr.colorControlActivated);
            int colorOnSurface = MaterialColors.getColor(this, C0098R.attr.colorOnSurface);

...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        float popupCornerRadius = (float) this.context.getResources().getDimensionPixelOffset(C0098R.dimen.mtrl_shape_corner_size_small_component);
        float exposedDropdownPopupElevation = (float) this.context.getResources().getDimensionPixelOffset(C0098R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int exposedDropdownPopupVerticalPadding = this.context.getResources().getDimensionPixelOffset(C0098R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.textInputLayout.setEndIconDrawable(this.customEndIcon == 0 ? IS_LOLLIPOP ? C0098R.C0100drawable.mtrl_dropdown_arrow : C0098R.C0100drawable.mtrl_ic_arrow_drop_down : this.customEndIcon);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0098R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView editText) {
        if (!isEditable(editText)) {
            ...
            int rippleColor = MaterialColors.getColor(editText, C0098R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView editText, int rippleColor, int[][] states, MaterialShapeDrawable boxBackground) {
        ...
        int surfaceColor = MaterialColors.getColor(editText, C0098R.attr.colorSurface);

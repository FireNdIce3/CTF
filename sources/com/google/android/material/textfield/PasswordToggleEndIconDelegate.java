...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(this.customEndIcon == 0 ? C0098R.C0100drawable.design_password_eye : this.customEndIcon);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0098R.string.password_toggle_content_description));

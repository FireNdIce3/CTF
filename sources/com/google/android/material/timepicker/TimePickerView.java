...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View v) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) v.getTag(C0098R.C0101id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0098R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0098R.C0101id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C0098R.C0101id.material_clock_period_toggle);
        this.toggle = materialButtonToggleGroup;
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                int period = checkedId == C0098R.C0101id.material_clock_period_pm_button ? 1 : 0;
        ...
        Chip chip = (Chip) findViewById(C0098R.C0101id.material_minute_tv);
        this.minuteView = chip;
        Chip chip2 = (Chip) findViewById(C0098R.C0101id.material_hour_tv);
        this.hourView = chip2;
        this.clockHandView = (ClockHandView) findViewById(C0098R.C0101id.material_clock_hand);
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0098R.C0101id.selection_type, 12);
        this.hourView.setTag(C0098R.C0101id.selection_type, 10);
    ...
    public void updateTime(int period, int hourOfDay, int minute) {
        this.toggle.check(period == 1 ? C0098R.C0101id.material_clock_period_pm_button : C0098R.C0101id.material_clock_period_am_button);
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C0098R.C0101id.material_clock_display, sideToClear);

...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Chip chip2 = (Chip) inflater.inflate(C0098R.layout.material_time_chip, this, false);
        this.chip = chip2;
        TextInputLayout textInputLayout2 = (TextInputLayout) inflater.inflate(C0098R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C0098R.C0101id.material_label);

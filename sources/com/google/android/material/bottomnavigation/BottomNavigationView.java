...
public class BottomNavigationView extends NavigationBarView {
    ...
    public BottomNavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, C0098R.attr.bottomNavigationStyle);
    }

    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, C0098R.style.Widget_Design_BottomNavigationView);
    }

    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        Context context2 = getContext();
        TintTypedArray attributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0098R.styleable.BottomNavigationView, defStyleAttr, defStyleRes, new int[0]);
        setItemHorizontalTranslationEnabled(attributes.getBoolean(C0098R.styleable.BottomNavigationView_itemHorizontalTranslationEnabled, true));
        if (attributes.hasValue(C0098R.styleable.BottomNavigationView_android_minHeight)) {
            setMinimumHeight(attributes.getDimensionPixelSize(C0098R.styleable.BottomNavigationView_android_minHeight, 0));
        }
        attributes.recycle();
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        divider.setBackgroundColor(ContextCompat.getColor(context, C0098R.C0099color.design_bottom_navigation_shadow_color));
        divider.setLayoutParams(new FrameLayout.LayoutParams(-1, getResources().getDimensionPixelSize(C0098R.dimen.design_bottom_navigation_shadow_height)));
        addView(divider);
    }

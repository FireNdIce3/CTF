...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0098R.C0101id.snackbar_text);
        this.actionView = (Button) findViewById(C0098R.C0101id.snackbar_action);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float actionTextColorAlpha) {
        if (actionTextColorAlpha != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C0098R.attr.colorSurface), this.actionView.getCurrentTextColor(), actionTextColorAlpha));
        }
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C0098R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0098R.dimen.design_snackbar_padding_vertical);

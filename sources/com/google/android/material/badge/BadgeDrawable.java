...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C0098R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C0098R.attr.badgeStyle;
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(Context context) {
            this.badgeTextColor = new TextAppearance(context, C0098R.style.TextAppearance_MaterialComponents_Badge).getTextColor().getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C0098R.string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C0098R.plurals.mtrl_badge_content_description;
            this.contentDescriptionExceedsMaxBadgeNumberRes = C0098R.string.mtrl_exceed_max_badge_number_content_description;
            this.isVisible = true;
        }
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0098R.styleable.Badge, defStyleAttr, defStyleRes, new int[0]);
        setMaxCharacterCount(a.getInt(C0098R.styleable.Badge_maxCharacterCount, 4));
        if (a.hasValue(C0098R.styleable.Badge_number)) {
            setNumber(a.getInt(C0098R.styleable.Badge_number, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, a, C0098R.styleable.Badge_backgroundColor));
        if (a.hasValue(C0098R.styleable.Badge_badgeTextColor)) {
            setBadgeTextColor(readColorFromAttributes(context, a, C0098R.styleable.Badge_badgeTextColor));
        }
        setBadgeGravity(a.getInt(C0098R.styleable.Badge_badgeGravity, TOP_END));
        setHorizontalOffsetWithoutText(a.getDimensionPixelOffset(C0098R.styleable.Badge_horizontalOffset, 0));
        setVerticalOffsetWithoutText(a.getDimensionPixelOffset(C0098R.styleable.Badge_verticalOffset, 0));
        setHorizontalOffsetWithText(a.getDimensionPixelOffset(C0098R.styleable.Badge_horizontalOffsetWithText, getHorizontalOffsetWithoutText()));
        setVerticalOffsetWithText(a.getDimensionPixelOffset(C0098R.styleable.Badge_verticalOffsetWithText, getVerticalOffsetWithoutText()));
        if (a.hasValue(C0098R.styleable.Badge_badgeRadius)) {
            this.badgeRadius = (float) a.getDimensionPixelSize(C0098R.styleable.Badge_badgeRadius, (int) this.badgeRadius);
        }
        if (a.hasValue(C0098R.styleable.Badge_badgeWidePadding)) {
            this.badgeWidePadding = (float) a.getDimensionPixelSize(C0098R.styleable.Badge_badgeWidePadding, (int) this.badgeWidePadding);
        }
        if (a.hasValue(C0098R.styleable.Badge_badgeWithTextRadius)) {
            this.badgeWithTextRadius = (float) a.getDimensionPixelSize(C0098R.styleable.Badge_badgeWithTextRadius, (int) this.badgeWithTextRadius);
        }
        a.recycle();
    }
    ...
    private BadgeDrawable(Context context) {
        ...
        this.badgeRadius = (float) res.getDimensionPixelSize(C0098R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = (float) res.getDimensionPixelSize(C0098R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = (float) res.getDimensionPixelSize(C0098R.dimen.mtrl_badge_with_text_radius);
        TextDrawableHelper textDrawableHelper2 = new TextDrawableHelper(this);
        this.textDrawableHelper = textDrawableHelper2;
        textDrawableHelper2.getTextPaint().setTextAlign(Paint.Align.CENTER);
        this.savedState = new SavedState(context);
        setTextAppearanceResource(C0098R.style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    private void tryWrapAnchorInCompatParent(final View anchorView) {
        ...
        if (anchorViewParent == null || anchorViewParent.getId() != C0098R.C0101id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != anchorViewParent) {
                ...
                frameLayout.setId(C0098R.C0101id.mtrl_anchor_parent);
    ...
    private void calculateCenterAndBounds(Context context, Rect anchorRect, View anchorView) {
        ...
        int inset = context.getResources().getDimensionPixelSize(hasNumber() ? C0098R.dimen.mtrl_badge_text_horizontal_edge_offset : C0098R.dimen.mtrl_badge_horizontal_edge_offset);
    ...
    private String getBadgeText() {
        ...
        return context.getString(C0098R.string.mtrl_exceed_max_badge_number_suffix, new Object[]{Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX});
    }

...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(context, C0098R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C0098R.attr.materialCalendarStyle, C0098R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View root = layoutInflater.inflate(this.fullscreen ? C0098R.layout.mtrl_picker_fullscreen : C0098R.layout.mtrl_picker_dialog, viewGroup);
        Context context = root.getContext();
        if (this.fullscreen) {
            root.findViewById(C0098R.C0101id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            root.findViewById(C0098R.C0101id.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) root.findViewById(C0098R.C0101id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) root.findViewById(C0098R.C0101id.mtrl_picker_header_toggle);
        TextView titleTextView = (TextView) root.findViewById(C0098R.C0101id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) root.findViewById(C0098R.C0101id.confirm_button);
        ...
        Button cancelButton = (Button) root.findViewById(C0098R.C0101id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int inset = getResources().getDimensionPixelOffset(C0098R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C0098R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void startPickerFragment() {
        ...
        fragmentTransaction.replace(C0098R.C0101id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton toggle) {
        ...
        if (this.headerToggleButton.isChecked()) {
            contentDescription = toggle.getContext().getString(C0098R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            contentDescription = toggle.getContext().getString(C0098R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        toggleDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C0098R.C0100drawable.material_ic_calendar_black_24dp));
        toggleDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C0098R.C0100drawable.material_ic_edit_black_24dp));
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C0098R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(Context context, int attributeResId) {
        TypedArray a = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C0098R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{attributeResId});
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        int padding = resources.getDimensionPixelOffset(C0098R.dimen.mtrl_calendar_content_padding);
        int daysInWeek = Month.current().daysInWeek;
        return (padding * 2) + (daysInWeek * resources.getDimensionPixelSize(C0098R.dimen.mtrl_calendar_day_width)) + ((daysInWeek - 1) * resources.getDimensionPixelOffset(C0098R.dimen.mtrl_calendar_month_horizontal_padding));
    }
